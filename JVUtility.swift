...
public class JVUtility: NSObject {

    public static func findColor(_ average: Double) -> UIColor
    {
        if average < 0.0
        {
            return UIColor.gray
    ...
    public static func labelHeight(_ text: NSString, font: UIFont, width: CGFloat) -> CGSize
    {
